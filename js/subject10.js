function Calculate(){
    ...
    var sub9= parseInt(document.getElementById("s9").value);
    var sub10= parseInt(document.getElementById("s10").value);
    ...
    var cr9= parseInt(document.getElementById("c9").value);
    var cr10= parseInt(document.getElementById("c10").value);

   
    var cr=cr1+cr2+cr3+cr4+cr5+cr6+cr7+cr8+cr9+cr10;
    var sgpa = ((sub1*cr1)+(sub2*cr2)+(sub3*cr3)+(sub4*cr4)+(sub5*cr5)+(sub6*cr6)+(sub7*cr7)+(sub8*cr8)+(sub9*cr9)+(sub10*cr10))/cr;
    if(!isNaN(sgpa)) {
